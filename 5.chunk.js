...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__class_routing__ = __webpack_require__(774);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__class_component__ = __webpack_require__(747);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__class_manage_component__ = __webpack_require__(746);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__class_service__ = __webpack_require__(738);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_multiselect_multiselect_component__ = __webpack_require__(739);
...
var classComponentList = [__WEBPACK_IMPORTED_MODULE_7__class_component__["a" /* ClassComponent */], __WEBPACK_IMPORTED_MODULE_8__class_manage_component__["a" /* ClassManageComponent */]];
...
ClassModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__class_routing__["a" /* routing */],
            ...
            __WEBPACK_IMPORTED_MODULE_12__components_multiselect_multiselect_component__["a" /* MultiSelectModule */],
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_7__class_component__["a" /* ClassComponent */], __WEBPACK_IMPORTED_MODULE_8__class_manage_component__["a" /* ClassManageComponent */]],
        providers: [__WEBPACK_IMPORTED_MODULE_9__class_service__["a" /* ClassService */], __WEBPACK_IMPORTED_MODULE_11__services_pagination_service__["a" /* PaginationService */], __WEBPACK_IMPORTED_MODULE_10__user_user_service__["a" /* UserService */]],
    })
], ClassModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__class_service__ = __webpack_require__(738);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ClassManageComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ClassManageComponent = (function () {
    function ClassManageComponent(classService, route, router, paginationService) {
        this.classService = classService;
        this.route = route;
        this.router = router;
        this.paginationService = paginationService;
        this.isSubscribe = true;
        this.title = 'Manage class';
        this.query = '';
    }
    ClassManageComponent.prototype.ngOnInit = function () {
        this.classServiceUrl = __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */].serviceURL;
        this.getClass();
    };
    ClassManageComponent.prototype.ngOnDestroy = function () {
        this.isSubscribe = false;
    };
    // New class
    ClassManageComponent.prototype.newClass = function () {
        this.router.navigate(['class/class/']);
    };
    // Get class
    ClassManageComponent.prototype.getClass = function () {
        var _this = this;
        $('#popup').fadeIn();
        $('#fade').fadeIn();
        this.classService.getClasses().takeWhile(function () { return _this.isSubscribe; })
    ...
    // Update class
    ClassManageComponent.prototype.updateClass = function (id) {
        this.returnUrl = "class/class/" + id;
        this.router.navigate([this.returnUrl]);
    };
    ClassManageComponent.prototype.setClassID = function (id) {
        // console.log(id);
        this.classID = id;
    };
    // Delete class
    ClassManageComponent.prototype.deleteClass = function () {
        var _this = this;
        this.classService.deleteClass(this.classID).takeWhile(function () { return _this.isSubscribe; }).subscribe(function (data) {
            // refresh the list
            _this.getClass();
            return true;
        }, function (error) {
    ...
    ClassManageComponent.prototype.getFacultyName = function (faculties) {
        var faculty = '';
...
var _a, _b, _c, _d;
//# sourceMappingURL=class-manage.component.js.map
...
var ClassComponent = (function () {
    function ClassComponent(route, router, classService, commonService, _http, userService, commonProperties) {
        this.route = route;
        this.router = router;
        this.classService = classService;
        this.commonService = commonService;
        ...
        this.placeholder = 'Search Faculty';
        this.actives = [
            { id: 0, name: 'False' },
            { id: 1, name: 'True' },
        ];
        this.returnUrl = "class/manageclass/";
    ...
    // for user|Faculty
    ClassComponent.prototype.getFaculties = function () {
        var _this = this;
        this.userService.getUserByRole('2').takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) {
    ...
    // end for the same 
    // Get class
    ClassComponent.prototype.getClass = function () {
        var _this = this;
        this.classService.getClasses().takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) { return _this.classList = resData; }, function (err) { return console.error(err); });
    };
    ClassComponent.prototype.getclassByID = function (id) {
        var _this = this;
        this.classService.getClassByID(id).takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) {
            _this.classSelected = resData[0];
            _this.classSelected.IsActive = parseInt(_this.classSelected.IsActive);
            //  console.log(resData[0]);
            //  console.log(this.classSelected);
            _this.selectedFacultyID = _this.classSelected.FacultyID.split(',');
            var faculty = _this.classSelected.Faculty.split('#');
            for (var i = 0; i < faculty.length; i++) {
                _this.selectedFaculty.push({ ID: parseInt(faculty[i].split(',')[0]),
                    FirstName: faculty[i].split(',')[1] });
            }
            //  console.log(this.classSelected.FacultyID);
        }, function (err) { return console.error(err); });
    };
    ClassComponent.prototype.HideMessage = function () {
        this.message = '';
        // return this.isErrorMessage = !this.isErrorMessage;
    };
    // Update class
    ClassComponent.prototype.updateclass = function (id, objClass) {
        var _this = this;
        objClass.ID = id;
        objClass.LastUpdatedBy = this.commonProperties.currentUser.ID; // JSON.parse(localStorage.getItem('currentUser')).ID;
        objClass.LastModifiedOn = new Date();
        objClass.CreatedBy = this.classSelected.CreatedBy;
        objClass.CreatedOn = this.classSelected.CreatedOn;
        objClass.FacultyID = this.selectedFacultyID.join();
        this.classService.updateClass(id, objClass).takeWhile(function () { return _this.isSubscribe; }).subscribe(function (data) {
            // refresh the list
            // this.getclass();
            _this.message = 'class updated successfully! ';
            // this.router.navigate([this.returnUrl]);
            return true;
        }, function (error) {
    ...
    ClassComponent.prototype.SuperAd = function (isSuperAdmin) {
        // console.log(isSuperAdmin);
        // console.log(this.selectedItem);
        // alert(isSuperAdmin.value);
    };
    ClassComponent.prototype.onBack = function () {
        this.router.navigate([this.returnUrl]);
    };
    ClassComponent.prototype.selectFaculty = function (ID) {
        // console.log(this.classSelected.length);
        if (this.classSelected.length != undefined) {
            this.classSelected.FacultyID.forEach(function (element) {
                if (ID == element) {
                    console.log(element);
    ...
    ClassComponent.prototype.saveclass = function (objClass) {
        var _this = this;
        objClass.CreatedBy = this.commonProperties.currentUser.ID; // JSON.parse(localStorage.getItem('currentUser')).ID;
        objClass.CreatedOn = new Date();
        this.classService.saveClass(objClass).takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) {
            // this.getclass();
    ...
    // Save class Record
    ClassComponent.prototype.submitClass = function (value) {
        ...
        // value.value.facultyID.forEach(el => {
        //   // console.log(el);
        //   selectedFaculty = `${selectedFaculty},${el}`;
        // });
        // value.value.facultyID = selectedFaculty.substr(1, selectedFaculty.length - 1);
        value.value.facultyID = this.selectedFacultyID.join();
        // update the class record
        if (this.id > 0) {
            this.updateclass(this.id, value.value);
            value.form.reset();
        }
        else {
            this.saveclass(value.value);
            value.form.reset();
        }
    };
    ClassComponent.prototype.onAutoSelectionChanged = function (item) {
        this.selectedItem = item;
        this.selectedFacultyID.push(item.ID);
        // console.log(this.selectedFacultyID.join());
    };
    ClassComponent.prototype.onMultiSelectionRemove = function (item) {
...
ClassComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__class_service__["a" /* ClassService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__class_service__["a" /* ClassService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__services_common_service__["a" /* CommonService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__services_common_service__["a" /* CommonService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_7__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__angular_http__["b" /* Http */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_8__user_user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__user_user_service__["a" /* UserService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */]) === "function" && _g || Object])
], ClassComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__class_component__ = __webpack_require__(747);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__class_manage_component__ = __webpack_require__(746);
...
var routes = [
    {
        path: '',
        children: [
            { path: 'class', component: __WEBPACK_IMPORTED_MODULE_1__class_component__["a" /* ClassComponent */] },
            { path: 'class/:id', component: __WEBPACK_IMPORTED_MODULE_1__class_component__["a" /* ClassComponent */] },
            { path: 'manageclass', component: __WEBPACK_IMPORTED_MODULE_2__class_manage_component__["a" /* ClassManageComponent */] },
        ],
    },
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=class.routing.js.map
