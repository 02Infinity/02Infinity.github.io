...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__section_routing__ = __webpack_require__(781);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__section_component__ = __webpack_require__(758);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__section_manage_component__ = __webpack_require__(757);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__section_service__ = __webpack_require__(743);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__user_user_service__ = __webpack_require__(735);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__class_class_service__ = __webpack_require__(738);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__services_pagination_service__ = __webpack_require__(654);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_multiselect_multiselect_component__ = __webpack_require__(739);
...
var sectionComponentList = [__WEBPACK_IMPORTED_MODULE_7__section_component__["a" /* SectionComponent */], __WEBPACK_IMPORTED_MODULE_8__section_manage_component__["a" /* SectionManageComponent */]];
...
SectionModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__section_routing__["a" /* routing */],
            ...
            __WEBPACK_IMPORTED_MODULE_13__components_multiselect_multiselect_component__["a" /* MultiSelectModule */],
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_7__section_component__["a" /* SectionComponent */], __WEBPACK_IMPORTED_MODULE_8__section_manage_component__["a" /* SectionManageComponent */]],
        providers: [__WEBPACK_IMPORTED_MODULE_9__section_service__["a" /* SectionService */], __WEBPACK_IMPORTED_MODULE_12__services_pagination_service__["a" /* PaginationService */], __WEBPACK_IMPORTED_MODULE_10__user_user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_11__class_class_service__["a" /* ClassService */]],
    })
], SectionModule);
...
var UserService = (function () {
    ...
    function UserService(http, commonService) {
        ...
        this.userServiceUrl = __WEBPACK_IMPORTED_MODULE_2__common_properties__["a" /* CommonProperties */].serviceURL + "api/admins/";
    }
    ...
    UserService.prototype.getUserByRole = function (role) {
        return this.http.get(this.userServiceUrl + "GetUserByRole/" + role)
            .map(function (res) { return res.json(); });
    };
    UserService.prototype.saveUser = function (user) {
        var body = JSON.stringify(user);
        return this.http.post(this.userServiceUrl, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])())
            .map(function (res) { return res.json(); });
    };
    ...
    UserService.prototype.updateUser = function (id, user) {
        var body = JSON.stringify(user);
        return this.http.put("" + this.userServiceUrl + id, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])()).map(function (res) { return res.json(); });
    };
    UserService.prototype.uploadProfile = function (fileList, fileName) {
        if (fileList.length > 0) {
            var file = fileList[0];
            var formData = new FormData();
            formData.append('uploadFile', file, fileName);
            // this.commonService.uploadFile(formData);
            this.commonService.uploadFile(formData, 'User');
        }
    };
    return UserService;
}());
...
var ClassService = (function () {
    // preferred to use template literal rather concatination  like below line
    // CommonProperties.serviceURL + 'api/admins/';  // URL to web api 
    function ClassService(http, commonService) {
        this.http = http;
        this.commonService = commonService;
        this.classServiceUrl = __WEBPACK_IMPORTED_MODULE_2__common_properties__["a" /* CommonProperties */].serviceURL + "api/classes/";
    }
    ClassService.prototype.getClasses = function () {
        return this.http.get(this.classServiceUrl)
            .map(function (res) { return res.json(); });
    };
    ClassService.prototype.getClassByID = function (id) {
        return this.http.get("" + this.classServiceUrl + id)
            .map(function (res) { return res.json(); });
    };
    ClassService.prototype.saveClass = function (objclass) {
        var body = JSON.stringify(objclass);
        return this.http.post(this.classServiceUrl, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])())
            .map(function (res) { return res.json(); });
    };
    ClassService.prototype.deleteClass = function (id) {
        return this.http.delete("" + this.classServiceUrl + id);
    };
    ClassService.prototype.updateClass = function (id, objclass) {
        var body = JSON.stringify(objclass);
        return this.http.put("" + this.classServiceUrl + id, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])()).map(function (res) { return res.json(); });
    };
    return ClassService;
}());
...
var MultiSelectComponent = (function () {
    function MultiSelectComponent(myElement) {
        this.myElement = myElement;
        this.query = '';
        this.onSelect = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* EventEmitter */]();
        this.onRemoveItem = new __WEBPACK_IMPORTED_MODULE_0__angular_core__["F" /* EventEmitter */]();
        this.filteredList = [];
        this.selected = [];
        this.elementRef = myElement;
    }
    MultiSelectComponent.prototype.filter = function () {
        if (this.query !== '' && this.query.length > 1) {
            this.filteredList = this.listItems.filter(function (el) {
    ...
    MultiSelectComponent.prototype.remove = function (item) {
...
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_5" /* Output */])(),
    __metadata("design:type", Object)
], MultiSelectComponent.prototype, "onRemoveItem", void 0);
__decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["O" /* Input */])(),
    __metadata("design:type", Object)
...
MultiSelectComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* Component */])({
        ...
        template: "\n    <input id=\"multiSelect\" type=\"text\" placeholder={{placeholder}} class=\"form-control\" [(ngModel)]=query (keyup)=filter()>\n   \n  <div class=\"suggestions\" *ngIf=\"filteredList.length > 0\">\n      <ul *ngFor=\"let item of filteredList\" >\n          <li >\n              <a (click)=\"select(item)\">{{item.FirstName}}</a>\n          </li>\n      </ul>\n  </div>\n  <div *ngFor=\"let item of selected\">\n  <div class=\"selected\" >\n      <span>{{item.FirstName}}</span>\n      <a (click)=\"remove(item)\">x</a>\n  </div>\n</div>\n\n",
...
var SectionService = (function () {
    // preferred to use template literal rather concatination  like below line
    // CommonProperties.serviceURL + 'api/admins/';  // URL to web api 
    function SectionService(http, commonService) {
        this.http = http;
        this.commonService = commonService;
        this.sectionServiceUrl = __WEBPACK_IMPORTED_MODULE_2__common_properties__["a" /* CommonProperties */].serviceURL + "api/sections/";
    }
    SectionService.prototype.getSection = function () {
        return this.http.get(this.sectionServiceUrl)
            .map(function (res) { return res.json(); });
    };
    SectionService.prototype.getSectionByID = function (id) {
        return this.http.get("" + this.sectionServiceUrl + id)
            .map(function (res) { return res.json(); });
    };
    SectionService.prototype.saveSection = function (objSection) {
        var body = JSON.stringify(objSection);
        return this.http.post(this.sectionServiceUrl, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])())
            .map(function (res) { return res.json(); });
    };
    SectionService.prototype.deleteSection = function (id) {
        return this.http.delete("" + this.sectionServiceUrl + id);
    };
    SectionService.prototype.updateSection = function (id, objSection) {
        var body = JSON.stringify(objSection);
        return this.http.put("" + this.sectionServiceUrl + id, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])()).map(function (res) { return res.json(); });
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__section_service__ = __webpack_require__(743);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SectionManageComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SectionManageComponent = (function () {
    function SectionManageComponent(sectionService, route, router, paginationService) {
        this.sectionService = sectionService;
        this.route = route;
        this.router = router;
        this.paginationService = paginationService;
        this.title = 'Manage section';
        this.query = '';
        this.isSubscribe = true;
    }
    SectionManageComponent.prototype.ngOnInit = function () {
        this.sectionServiceUrl = __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */].serviceURL;
        this.getSection();
    };
    SectionManageComponent.prototype.ngOnDestroy = function () {
        this.isSubscribe = false;
    };
    // New section
    SectionManageComponent.prototype.newSection = function () {
        this.router.navigate(['section/section/']);
    };
    // Get section
    SectionManageComponent.prototype.getSection = function () {
        var _this = this;
        $('#popup').fadeIn();
        $('#fade').fadeIn();
    ...
    // Update section
    SectionManageComponent.prototype.updateSection = function (id) {
        this.returnUrl = "section/section/" + id;
        this.router.navigate([this.returnUrl]);
    };
    SectionManageComponent.prototype.setSectionID = function (id) {
        // console.log(id);
        this.sectionID = id;
    };
    // Delete section
    SectionManageComponent.prototype.deleteSection = function () {
        var _this = this;
    ...
    SectionManageComponent.prototype.getFacultyName = function (faculties) {
        var faculty = '';
        faculties.split('#').forEach(function (el) {
            faculty = faculty + ", " + el.split(',')[0];
        });
        return faculty.substring(1);
    };
    return SectionManageComponent;
}());
SectionManageComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* Component */])({
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__section_service__["a" /* SectionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__section_service__["a" /* SectionService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__services_pagination_service__["a" /* PaginationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__services_pagination_service__["a" /* PaginationService */]) === "function" && _d || Object])
], SectionManageComponent);

var _a, _b, _c, _d;
//# sourceMappingURL=section-manage.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__user_user_service__ = __webpack_require__(735);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__class_class_service__ = __webpack_require__(738);
...
var SectionComponent = (function () {
    function SectionComponent(route, router, sectionService, commonService, _http, userService, classService, commonProperties) {
        this.route = route;
        this.router = router;
        this.sectionService = sectionService;
        this.commonService = commonService;
        ...
        this.returnUrl = "section/managesection/";
    ...
    // for user|Faculty
    SectionComponent.prototype.getFaculties = function () {
        var _this = this;
        this.userService.getUserByRole('2')
            .takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) {
            _this.faculties = resData;
    ...
    SectionComponent.prototype.getClasses = function () {
        ...
        this.classService.getClasses()
            .takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) {
            _this.classes = resData.filter(function (e) { return parseInt(e.IsActive) == 1; });
        }, function (err) { return console.error(err); });
    };
    // end for the same 
    // Get section
    SectionComponent.prototype.getSection = function () {
        var _this = this;
        this.sectionService.getSection()
            .takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) { return _this.sectionList = resData; }, function (err) { return console.error(err); });
    };
    SectionComponent.prototype.getSectionByID = function (id) {
        var _this = this;
        this.sectionService.getSectionByID(id)
            .takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) {
            _this.sectionSelected = resData[0];
            _this.sectionSelected.IsActive = parseInt(_this.sectionSelected.IsActive);
            _this.selectedFacultyID = _this.sectionSelected.FacultyID.split(',');
            var faculty = _this.sectionSelected.Faculty.split('#');
            for (var i = 0; i < faculty.length; i++) {
                _this.selectedFaculty.push({ ID: parseInt(faculty[i].split(',')[0]),
                    FirstName: faculty[i].split(',')[1] });
            }
        }, function (err) { return console.error(err); });
    };
    SectionComponent.prototype.HideMessage = function () {
        this.message = '';
        // return this.isErrorMessage = !this.isErrorMessage;
    };
    // Update section
    SectionComponent.prototype.updateSection = function (id, objsection) {
        var _this = this;
        objsection.ID = id;
        objsection.LastUpdatedBy = this.commonProperties.currentUser.ID; //JSON.parse(localStorage.getItem('currentUser')).ID;
        objsection.LastModifiedOn = new Date();
        objsection.FacultyID = this.selectedFacultyID.join();
        this.sectionService.updateSection(id, objsection)
            .takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (data) {
            // refresh the list
            // this.getsection();
            _this.message = 'section updated successfully! ';
            // this.router.navigate([this.returnUrl]);
            return true;
        }, function (error) {
    ...
    SectionComponent.prototype.SuperAd = function (isSuperAdmin) {
        // console.log(isSuperAdmin);
        // console.log(this.selectedItem);
        // alert(isSuperAdmin.value);
    };
    SectionComponent.prototype.onBack = function () {
        this.router.navigate([this.returnUrl]);
    };
    SectionComponent.prototype.saveSection = function (objsection) {
        var _this = this;
        objsection.CreatedBy = this.commonProperties.currentUser.ID; //JSON.parse(localStorage.getItem('currentUser')).ID;
        objsection.CreatedOn = new Date();
        this.sectionService.saveSection(objsection)
            .takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) {
            // this.getsection();
    ...
    // Save section Record
    SectionComponent.prototype.submitSection = function (value) {
        // console.log(value.value);
        if (!value.form.valid || this.selectedFacultyID.length == 0) {
            this.message = 'Please enter required values!';
            this.isErrorMessage = true;
            this.sectionname = 'danger';
            return;
        }
        value.value.facultyID = this.selectedFacultyID.join();
        // update the section record
        if (this.id > 0) {
            this.updateSection(this.id, value.value);
            value.form.reset();
        }
        else {
            this.saveSection(value.value);
            value.form.reset();
        }
    };
    SectionComponent.prototype.onAutoSelectionChanged = function (item) {
        this.selectedItem = item;
        this.selectedFacultyID.push(item.ID);
        // console.log(this.selectedFacultyID.join());
    };
    SectionComponent.prototype.onMultiSelectionRemove = function (item) {
        this.selectedFacultyID.splice(this.selectedFacultyID.indexOf(String(item.ID)), 1);
        // console.log(this.selectedFacultyID.join());
    };
...
SectionComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__section_service__["a" /* SectionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__section_service__["a" /* SectionService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__services_common_service__["a" /* CommonService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__services_common_service__["a" /* CommonService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_7__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__angular_http__["b" /* Http */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_8__user_user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__user_user_service__["a" /* UserService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_9__class_class_service__["a" /* ClassService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_9__class_class_service__["a" /* ClassService */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */]) === "function" && _h || Object])
], SectionComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__section_component__ = __webpack_require__(758);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__section_manage_component__ = __webpack_require__(757);
...
var routes = [
    {
        path: '',
        children: [
            { path: 'section', component: __WEBPACK_IMPORTED_MODULE_1__section_component__["a" /* SectionComponent */] },
            { path: 'section/:id', component: __WEBPACK_IMPORTED_MODULE_1__section_component__["a" /* SectionComponent */] },
            { path: 'managesection', component: __WEBPACK_IMPORTED_MODULE_2__section_manage_component__["a" /* SectionManageComponent */] },
        ],
    },
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=section.routing.js.map
...
module.exports = "\n<div class=\"widgets\">\n        <div class=\"row\">\n            <div class=\"col-md-12\">\n                <div>\n                        <div baCardBlur class=\"animated fadeIn card {{cardType}} {{baCardClass || 'with-scroll'}}\" zoom-in>\n                                <!-- <ba-card title=\"Parent Form\" baCardClass=\"with-scroll\"> -->\n                                        <div class=\"card-header clearfix\" >\n                                             <div class=\"form-group row\">\n                                                <div class=\"col-md-5\" ><h3 class=\"card-title\" translate>Section Form</h3></div>\n                                                 <!-- <label class=\"col-sm-2 form-control-label\">Rows on page</label> -->\n                                                <div class=\"col-md-7\" style=\"float:right;\"> \n                                                   <button type=\"button\"  (click)=\"onBack()\" class=\"btn btn-primary btnBack\"><i class=\"fa fa-arrow-left\"></i> Back </button>\n                                                </div>\n                                                <div style=\"clear:both;\"></div>\n                                            </div>\n                                        </div>\n                                        <div class=\"card-body\">\n                        <form #sectionForm=\"ngForm\" class=\"form-horizontal\" (ngSubmit)=\"submitSection(sectionForm)\">\n                            <!-- <div class=\"form-group row alert alert-success alert-dismissable\" >\n                                <label class=\"col-md-2\"> </label>\n                                <p class=\"form-group has-feedback col-md-10\" [ngClass]=\"isErrorMessage === true ? 'has-danger' : 'has-success'\">\n                                    <label class=\"form-control\" [ngClass]=\"isErrorMessage === true ? 'form-control-danger' : 'form-control-success'\" [style.color]=\"isErrorMessage === true ? 'red' : 'green' \" [ngStyle]=\"{'cursor':'pointer'}\" (click)=\"HideMessage()\"> {{message}} </label>\n                                </p>\n                            </div> -->\n                            <div class=\"alert alert-{{isErrorMessage?'danger':'success'}}\" *ngIf='message'>\n                                {{message}}\n                                <a class=\"close\" (click)=\"HideMessage()\">×</a>\n                            </div>\n                            <div class=\"form-group row\">\n                                    <label class=\"col-sm-2 form-control-label\">Class</label>\n                                    <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!classID.valid && classID.touched), 'has-success':(classID.valid && classID.touched)}\">\n                                        <select  #classID='ngModel' name=\"classID\" class=\"form-control\" required [(ngModel)]='sectionSelected.ClassID'>\n                                            <!-- <option value =\" \">Please select</option> -->\n                                            <option [ngValue]=\"class.ID\" *ngFor=\"let class of classes; let idx = index\" [selected]=\"class.ID == sectionSelected.ClassID\">{{class.Name}} - {{class.Code}} - {{class.Factuly}}</option>\n                                        </select>\n                                        <div *ngIf=\"classID.invalid && (classID.dirty || classID.touched)\" class=\"validationError\">\n                                            <div *ngIf=\"classID.errors.required\">\n                                                Class is required\n                                            </div>\n                                            \n                                        </div>\n                                    </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Name</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!Name.valid && Name.touched), 'has-success':(Name.valid && Name.touched)}\">\n                                    <input  name=\"Name\" #Name='ngModel' type=\"text\" class=\"form-control\" required  placeholder=\"Section Name\" [(ngModel)]=\"sectionSelected.Name\">\n                                    <div *ngIf=\"Name.invalid && (Name.dirty || Name.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"Name.errors.required\">\n                                            Name is required\n                                        </div>\n                                        \n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Short Code</label>\n                                <div class=\"col-sm-10\">\n                                    <input name=\"Code\" type=\"text\" class=\"form-control\" placeholder=\"Short Code\" [(ngModel)]=\"sectionSelected.Code\">\n                                </div>\n                            </div>\n                                          \n                            <div class=\"form-group row\">\n                                    <label class=\"col-sm-2 form-control-label\">Faculty</label>\n                                    <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(selectedFacultyID.length == 0), 'has-success':(selectedFacultyID.length > 0)}\">\n                                        <!-- <autocomplete-select *ngIf=\"faculties\" name=\"faculty\" [listItems] = 'faculties' (onSelect)='onAutoSelectionChanged($event)' > </autocomplete-select> -->\n                                        <multi-select required *ngIf=\"faculties\" [selected]='selectedFaculty' [placeholder]='placeholder' [listItems] = 'faculties' (onSelect)='onAutoSelectionChanged($event)' (onRemoveItem)='onMultiSelectionRemove($event)' ></multi-select>\n\n                                        <div *ngIf=\"selectedFacultyID.length == 0\" class=\"validationError\">\n                                            <div>\n                                                Faculty is required \n                                            </div>\n                                        </div>\n                                    </div>\n                            </div>\n\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Active</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!IsActive.valid && IsActive.touched), 'has-success':(IsActive.valid && IsActive.touched)}\">\n                                    <select id=\"IsActive\" #IsActive='ngModel' name=\"IsActive\" class=\"form-control\" required size=\"1\" [(ngModel)]='sectionSelected.IsActive'>\n                                        <!-- <option value =\" \">Please select</option> -->\n                                        <option [ngValue]=\"i.id\" *ngFor=\"let i of actives; let idx = index\" [selected]=\"i.id == sectionSelected.IsActive\">{{i.name}}</option>\n                                    </select>\n                                </div>\n                            </div>\n    \n                            <div class=\"form-group row\">\n                                <div class=\"offset-sm-2 col-sm-10\">\n                                    <!-- <button type=\"button\" style=\"margin-right:7px;\" (click)=\"onBack()\" class=\"btn btn-primary\"><i class=\"fa fa-arrow-left\"></i> Back </button> -->\n                                    <button type=\"submit\" class=\"btn btn-danger\" [disabled]='!sectionForm.form.valid'>Submit</button>\n                                    <!-- <button type=\"reset\" class=\"btn btn-sm btn-danger\"><i class=\"fa fa-ban\"></i> Reset </button> -->\n                                </div>\n                            </div>\n                        </form>\n                                        </div>\n                        </div>\n                </div>\n            </div>\n        </div>\n    </div>\n    "
