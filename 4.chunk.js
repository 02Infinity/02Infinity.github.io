...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__school_routing__ = __webpack_require__(780);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__school_component__ = __webpack_require__(756);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__school_manage_component__ = __webpack_require__(755);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__school_service__ = __webpack_require__(742);
...
var SchoolComponentList = [__WEBPACK_IMPORTED_MODULE_7__school_component__["a" /* SchoolComponent */]];
...
SchoolModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__school_routing__["a" /* routing */],
        ...
        declarations: [__WEBPACK_IMPORTED_MODULE_7__school_component__["a" /* SchoolComponent */], __WEBPACK_IMPORTED_MODULE_8__school_manage_component__["a" /* SchoolManageComponent */]],
        providers: [__WEBPACK_IMPORTED_MODULE_9__school_service__["a" /* SchoolService */], __WEBPACK_IMPORTED_MODULE_10__services_pagination_service__["a" /* PaginationService */]],
    })
], SchoolModule);
...
var SchoolService = (function () {
    ...
    function SchoolService(http, commonService) {
        this.http = http;
        this.commonService = commonService;
        this.SchoolServiceUrl = __WEBPACK_IMPORTED_MODULE_2__common_properties__["a" /* CommonProperties */].serviceURL + "api/schools/";
    }
    SchoolService.prototype.getSchools = function () {
        return this.http.get(this.SchoolServiceUrl)
            .map(function (res) { return res.json(); });
    };
    SchoolService.prototype.getSchoolByID = function (id) {
        return this.http.get("" + this.SchoolServiceUrl + id)
            .map(function (res) { return res.json(); });
    };
    SchoolService.prototype.getSchoolByRole = function (role) {
        return this.http.get(this.SchoolServiceUrl + "GetSchoolByRole/" + role)
            .map(function (res) { return res.json(); });
    };
    SchoolService.prototype.saveSchool = function (School) {
        var body = JSON.stringify(School);
        return this.http.post(this.SchoolServiceUrl, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])())
            .map(function (res) { return res.json(); });
    };
    SchoolService.prototype.deleteSchool = function (id) {
        return this.http.delete("" + this.SchoolServiceUrl + id);
    };
    SchoolService.prototype.updateSchool = function (id, School) {
        var body = JSON.stringify(School);
        return this.http.put("" + this.SchoolServiceUrl + id, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])()).map(function (res) { return res.json(); });
    };
    SchoolService.prototype.uploadProfile = function (fileList, fileName) {
        if (fileList.length > 0) {
            var file = fileList[0];
            var formData = new FormData();
            formData.append('uploadFile', file, fileName);
            // this.commonService.uploadFile(formData);
            this.commonService.uploadFile(formData, 'School');
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__school_service__ = __webpack_require__(742);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_pagination_service__ = __webpack_require__(654);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SchoolManageComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SchoolManageComponent = (function () {
    function SchoolManageComponent(SchoolService, route, router, paginationService) {
        this.SchoolService = SchoolService;
        this.route = route;
        this.router = router;
        this.paginationService = paginationService;
        this.title = 'Manage School';
        this.query = '';
    }
    SchoolManageComponent.prototype.ngOnInit = function () {
        this.SchoolServiceUrl = __WEBPACK_IMPORTED_MODULE_4__common_properties__["a" /* CommonProperties */].serviceURL;
        this.getSchool();
    };
    // New School
    SchoolManageComponent.prototype.newSchool = function () {
        this.router.navigate(['school/school/']);
    };
    // Get School
    SchoolManageComponent.prototype.getSchool = function () {
        var _this = this;
        $('#popup').fadeIn();
        $('#fade').fadeIn();
    ...
    // Update School
    SchoolManageComponent.prototype.updateSchool = function (id) {
        this.returnUrl = "school/school/" + id;
        this.router.navigate([this.returnUrl]);
    };
    SchoolManageComponent.prototype.setSchoolID = function (id) {
        console.log(id);
        this.SchoolID = id;
    };
    // Delete School
    SchoolManageComponent.prototype.deleteSchool = function () {
        var _this = this;
        // if (window.confirm(`Are you sure you want to delete ${id}?`)) {
        //  if (window.confirm(`Are you sure you want to delete ?`)) {
        this.SchoolService.deleteSchool(this.SchoolID).subscribe(function (data) {
            // refresh the list
            _this.getSchool();
            return true;
        }, function (error) {
    ...
    return SchoolManageComponent;
}());
SchoolManageComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* Component */])({
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__school_service__["a" /* SchoolService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__school_service__["a" /* SchoolService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_5__services_pagination_service__["a" /* PaginationService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__services_pagination_service__["a" /* PaginationService */]) === "function" && _d || Object])
], SchoolManageComponent);

var _a, _b, _c, _d;
//# sourceMappingURL=school-manage.component.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_rxjs_Observable___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_rxjs_Observable__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__common_properties__ = __webpack_require__(53);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_common_service__ = __webpack_require__(391);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_ng2_datepicker__ = __webpack_require__(681);
...
var SchoolComponent = (function () {
    function SchoolComponent(route, router, SchoolService, commonService, _http, sanitizer, commonProperties) {
        this.route = route;
        this.router = router;
        this.SchoolService = SchoolService;
        this.commonService = commonService;
        ...
        this.returnUrl = "school/manageschool/";
        this.secureImage = sanitizer.bypassSecurityTrustUrl(this.noImage);
        this.options = new __WEBPACK_IMPORTED_MODULE_8_ng2_datepicker__["b" /* DatePickerOptions */]();
        this.date = new __WEBPACK_IMPORTED_MODULE_8_ng2_datepicker__["c" /* DateModel */]();
    }
    ...
    SchoolComponent.prototype.getSchool = function () {
        var _this = this;
        this.SchoolService.getSchools()
            .subscribe(function (resData) { return _this.schoolList = resData; }, function (err) { return console.error(err); });
    };
    SchoolComponent.prototype.getSchoolByID = function (id) {
        var _this = this;
        this.SchoolService.getSchoolByID(id)
            .subscribe(function (resData) {
            _this.schoolSelected = resData;
            _this.activeIndex = _this.schoolSelected.IsActive;
            _this.schoolSelected.IsActive = parseInt(_this.schoolSelected.IsActive);
            _this.profileImg = _this.schoolSelected.ProfileImg;
            // 'url(' + CommonProperties.serviceURL+'/UploadFile/'+ this.profileImg + ')'
            _this.date.formatted = String(_this.schoolSelected.FYFrom).substring(0, 10);
            if (_this.profileImg) {
                $('#spnimgProfile').css('background-image', "url(" + __WEBPACK_IMPORTED_MODULE_4__common_properties__["a" /* CommonProperties */].serviceURL + "/UploadFile/School/" + _this.profileImg + ")");
            }
        }, function (err) { return console.error(err); });
    };
    SchoolComponent.prototype.HideMessage = function () {
        this.message = '';
        // return this.isErrorMessage = !this.isErrorMessage;
    };
    // Update School
    SchoolComponent.prototype.updateSchool = function (id, School) {
        var _this = this;
        School.ID = id;
        School.LastUpdatedBy = this.commonProperties.currentUser.ID; //JSON.parse(localStorage.getItem('currentUser')).ID;
        School.LastModifiedOn = new Date();
        School.ProfileImg = this.profileImg;
        this.SchoolService.updateSchool(id, School).subscribe(function (data) {
            // refresh the list
            // this.getSchool();
            _this.message = 'School updated successfully! ';
            // this.router.navigate([this.returnUrl]);
            return true;
        }, function (error) {
    ...
    SchoolComponent.prototype.onBack = function () {
        this.router.navigate([this.returnUrl]);
    };
    SchoolComponent.prototype.saveSchool = function (School) {
        var _this = this;
        School.CreatedBy = this.commonProperties.currentUser.ID; // JSON.parse(localStorage.getItem('currentUser')).ID;
        School.CreatedOn = new Date();
        School.ProfileImg = this.profileImg;
        //  console.log(School.ProfileImg);
    ...
    // Save School Record
    SchoolComponent.prototype.submitSchool = function (value) {
        ...
        value.value.FYFrom = value.value.FYFrom.formatted;
        ...
        if (this.id > 0) {
            ...
            this.updateSchool(this.id, value.value);
            value.form.reset();
        }
        else {
            // save image to folder
            ...
            this.saveSchool(value.value);
            value.form.reset();
        }
    };
    // file upload event  
    SchoolComponent.prototype.fileChange = function (event) {
    ...
    SchoolComponent.prototype.uploadProfile = function () {
        this.SchoolService.uploadProfile(this.fileList, this.profileImg);
        this.isUploaded = this.profileImg;
    };
    SchoolComponent.prototype.onDateChange = function (FYFrom) {
...
SchoolComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__school_service__["a" /* SchoolService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__school_service__["a" /* SchoolService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_5__services_common_service__["a" /* CommonService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__services_common_service__["a" /* CommonService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_6__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__angular_http__["b" /* Http */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_7__angular_platform_browser__["c" /* DomSanitizer */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__angular_platform_browser__["c" /* DomSanitizer */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_4__common_properties__["a" /* CommonProperties */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__common_properties__["a" /* CommonProperties */]) === "function" && _g || Object])
], SchoolComponent);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__school_component__ = __webpack_require__(756);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__school_manage_component__ = __webpack_require__(755);
...
var routes = [
    {
        path: '',
        children: [
            { path: 'school', component: __WEBPACK_IMPORTED_MODULE_1__school_component__["a" /* SchoolComponent */] },
            { path: 'school/:id', component: __WEBPACK_IMPORTED_MODULE_1__school_component__["a" /* SchoolComponent */] },
            { path: 'manageschool', component: __WEBPACK_IMPORTED_MODULE_2__school_manage_component__["a" /* SchoolManageComponent */] },
        ],
    },
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=school.routing.js.map
