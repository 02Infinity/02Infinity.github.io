...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_routing__ = __webpack_require__(784);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__user_component__ = __webpack_require__(765);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__user_manage_component__ = __webpack_require__(764);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__user_service__ = __webpack_require__(735);
...
var userComponentList = [__WEBPACK_IMPORTED_MODULE_7__user_component__["a" /* UserComponent */]];
...
UserModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        ...
        declarations: [__WEBPACK_IMPORTED_MODULE_7__user_component__["a" /* UserComponent */], __WEBPACK_IMPORTED_MODULE_8__user_manage_component__["a" /* UserManageComponent */]],
        providers: [__WEBPACK_IMPORTED_MODULE_9__user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_10__services_pagination_service__["a" /* PaginationService */]],
    })
], UserModule);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__user_service__ = __webpack_require__(735);
...
var UserManageComponent = (function () {
    function UserManageComponent(userService, route, router, paginationService) {
    ...
    UserManageComponent.prototype.ngOnInit = function () {
        this.userServiceUrl = __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */].serviceURL;
        this.getUser();
    };
    ...
    // New User
    UserManageComponent.prototype.newUser = function () {
        this.router.navigate(['user/user/']);
    };
    // Get User
    UserManageComponent.prototype.getUser = function () {
        var _this = this;
        $('#popup').fadeIn();
        $('#fade').fadeIn();
    ...
    // Update User
    UserManageComponent.prototype.updateUser = function (id) {
        this.returnUrl = "user/user/" + id;
        this.router.navigate([this.returnUrl]);
    };
    UserManageComponent.prototype.setUserID = function (id) {
        this.userID = id;
    };
    // Delete User
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_service__ = __webpack_require__(735);
...
var UserComponent = (function () {
    function UserComponent(route, router, userService, commonService, _http, sanitizer, commonProperties) {
        this.route = route;
        this.router = router;
        this.userService = userService;
        this.commonService = commonService;
        ...
        this.returnUrl = "user/manageuser/";
    ...
    UserComponent.prototype.getUser = function () {
        ...
        this.userService.getUsers()
            .takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) { return _this.userList = resData; }, function (err) { return console.error(err); });
    };
    UserComponent.prototype.getUserByID = function (id) {
        ...
        this.userService.getUserByID(id)
            .takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) {
            _this.userSelected = resData;
            _this.activeIndex = _this.userSelected.IsActive;
            _this.userSelected.IsSuperAdmin = parseInt(_this.userSelected.IsSuperAdmin);
            _this.userSelected.IsActive = parseInt(_this.userSelected.IsActive);
            _this.selectedItem = _this.isSuperAdmin[_this.userSelected.IsSuperAdmin];
            _this.profileImg = _this.userSelected.ProfileImg;
            // 'url(' + CommonProperties.serviceURL+'/UploadFile/'+ this.profileImg + ')'
            _this.date.formatted = String(_this.userSelected.DOB).substring(0, 10);
            if (_this.profileImg) {
                $('#spnimgProfile').css('background-image', "url(" + __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */].serviceURL + "/UploadFile/User/" + _this.profileImg + ")");
            }
        }, function (err) { return console.error(err); });
    };
    UserComponent.prototype.HideMessage = function () {
        this.message = '';
        // return this.isErrorMessage = !this.isErrorMessage;
    };
    // Update User
    UserComponent.prototype.updateUser = function (id, user) {
        var _this = this;
        user.ID = id;
        user.LastUpdatedBy = this.commonProperties.currentUser.ID; // JSON.parse(localStorage.getItem('currentUser')).ID;
    ...
    UserComponent.prototype.saveUser = function (user) {
        var _this = this;
        user.CreatedBy = this.commonProperties.currentUser.ID; // JSON.parse(localStorage.getItem('currentUser')).ID;
    ...
    // Save User Record
    UserComponent.prototype.submitUser = function (value) {
        ...
        if (this.id > 0) {
            ...
            this.updateUser(this.id, value.value);
            value.form.reset();
        }
        else {
            // save image to folder
    ...
    UserComponent.prototype.uploadProfile = function () {
        this.userService.uploadProfile(this.fileList, this.profileImg);
        this.isUploaded = this.profileImg;
    };
    UserComponent.prototype.onDateChange = function (dob) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__user_component__ = __webpack_require__(765);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__user_manage_component__ = __webpack_require__(764);
...
var routes = [
    {
        path: '',
        children: [
            { path: 'user', component: __WEBPACK_IMPORTED_MODULE_1__user_component__["a" /* UserComponent */] },
            { path: 'user/:id', component: __WEBPACK_IMPORTED_MODULE_1__user_component__["a" /* UserComponent */] },
            { path: 'manageuser', component: __WEBPACK_IMPORTED_MODULE_2__user_manage_component__["a" /* UserManageComponent */] },
        ],
    },
];
