...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__parent_routing__ = __webpack_require__(778);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__parent_component__ = __webpack_require__(753);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__parent_manage_component__ = __webpack_require__(752);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__parent_service__ = __webpack_require__(741);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__student_student_service__ = __webpack_require__(761);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__services_pagination_service__ = __webpack_require__(654);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_ng2_datepicker__ = __webpack_require__(681);
...
var parentComponentList = [__WEBPACK_IMPORTED_MODULE_7__parent_component__["a" /* ParentComponent */]];
...
ParentModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["a" /* NgModule */])({
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_3__parent_routing__["a" /* routing */],
        ...
        declarations: [__WEBPACK_IMPORTED_MODULE_7__parent_component__["a" /* ParentComponent */], __WEBPACK_IMPORTED_MODULE_8__parent_manage_component__["a" /* ParentManageComponent */]],
        providers: [__WEBPACK_IMPORTED_MODULE_9__parent_service__["a" /* ParentService */], __WEBPACK_IMPORTED_MODULE_11__services_pagination_service__["a" /* PaginationService */], __WEBPACK_IMPORTED_MODULE_10__student_student_service__["a" /* StudentService */]],
    })
], ParentModule);
...
var ParentService = (function () {
    ...
    function ParentService(http, commonService) {
        this.http = http;
        this.commonService = commonService;
        this.parentServiceUrl = __WEBPACK_IMPORTED_MODULE_2__common_properties__["a" /* CommonProperties */].serviceURL + "api/parents/";
    }
    ParentService.prototype.getParents = function () {
        return this.http.get(this.parentServiceUrl)
            .map(function (res) { return res.json(); });
    };
    ParentService.prototype.getParentByID = function (id) {
        return this.http.get("" + this.parentServiceUrl + id)
            .map(function (res) { return res.json(); });
    };
    ParentService.prototype.getParentByRole = function (role) {
        return this.http.get(this.parentServiceUrl + "GetParentByRole/" + role)
            .map(function (res) { return res.json(); });
    };
    ParentService.prototype.getParentByStudentID = function (id) {
        return this.http.get(this.parentServiceUrl + "GetParentByStudentID/" + id)
            .map(function (res) { return res.json(); });
    };
    ParentService.prototype.saveParent = function (parent) {
        var body = JSON.stringify(parent);
        return this.http.post(this.parentServiceUrl, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])())
            .map(function (res) { return res.json(); });
    };
    ParentService.prototype.deleteParent = function (id) {
        return this.http.delete("" + this.parentServiceUrl + id);
    };
    ParentService.prototype.updateParent = function (id, parent) {
        var body = JSON.stringify(parent);
        return this.http.put("" + this.parentServiceUrl + id, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])()).map(function (res) { return res.json(); });
    };
    ParentService.prototype.uploadProfile = function (fileList, fileName) {
        if (fileList.length > 0) {
            var file = fileList[0];
            var formData = new FormData();
            formData.append('uploadFile', file, fileName);
            // this.commonService.uploadFile(formData);
            this.commonService.uploadFile(formData, 'Parent');
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__parent_service__ = __webpack_require__(741);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ParentManageComponent; });
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ParentManageComponent = (function () {
    function ParentManageComponent(parentService, route, router, paginationService) {
        this.parentService = parentService;
        this.route = route;
        this.router = router;
        this.paginationService = paginationService;
        this.isSubscribe = true;
        this.title = 'Manage Parent';
        this.query = '';
    }
    ParentManageComponent.prototype.ngOnInit = function () {
        this.parentServiceUrl = __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */].serviceURL;
        this.getParent();
    };
    ParentManageComponent.prototype.ngOnDestroy = function () {
        this.isSubscribe = false;
    };
    // New Parent
    ParentManageComponent.prototype.newParent = function () {
        this.router.navigate(['parent/parent/']);
    };
    // Get Parent
    ParentManageComponent.prototype.getParent = function () {
        var _this = this;
        $('#popup').fadeIn();
        $('#fade').fadeIn();
        this.parentService.getParents().takeWhile(function () { return _this.isSubscribe; })
    ...
    // Update Parent
    ParentManageComponent.prototype.updateParent = function (id) {
        this.returnUrl = "parent/parent/" + id;
        this.router.navigate([this.returnUrl]);
    };
    ParentManageComponent.prototype.setParentID = function (id) {
        // console.log(id);
        this.parentID = id;
    };
    // Delete Parent
    ParentManageComponent.prototype.deleteParent = function () {
        var _this = this;
        // if (window.confirm(`Are you sure you want to delete ${id}?`)) {
        //  if (window.confirm(`Are you sure you want to delete ?`)) {
        this.parentService.deleteParent(this.parentID).takeWhile(function () { return _this.isSubscribe; }).subscribe(function (data) {
            // refresh the list
            _this.getParent();
            return true;
        }, function (error) {
    ...
    return ParentManageComponent;
}());
ParentManageComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["b" /* Component */])({
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__student_student_service__ = __webpack_require__(761);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_ng2_datepicker__ = __webpack_require__(681);
...
var ParentComponent = (function () {
    function ParentComponent(route, router, parentService, commonService, _http, sanitizer, studentService, commonProperties) {
        this.route = route;
        this.router = router;
        this.parentService = parentService;
        this.commonService = commonService;
        ...
        this.returnUrl = "parent/manageparent/";
        this.secureImage = sanitizer.bypassSecurityTrustUrl(this.noImage);
        this.options = new __WEBPACK_IMPORTED_MODULE_10_ng2_datepicker__["b" /* DatePickerOptions */]();
        this.date = new __WEBPACK_IMPORTED_MODULE_10_ng2_datepicker__["c" /* DateModel */]();
    }
    ...
    // Get Parent
    ParentComponent.prototype.getParent = function () {
        var _this = this;
        this.parentService.getParents()
            .takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) { return _this.parentList = resData; }, function (err) { return console.error(err); });
    };
    ParentComponent.prototype.getParentByID = function (id) {
        var _this = this;
        this.parentService.getParentByID(id).takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) {
            _this.parentSelected = resData;
            // console.log(this.parentSelected.IsActive);
            _this.activeIndex = _this.parentSelected.IsActive;
            _this.parentSelected.IsActive = parseInt(_this.parentSelected.IsActive);
            _this.profileImg = _this.parentSelected.ProfileImg;
            // 'url(' + CommonProperties.serviceURL+'/UploadFile/'+ this.profileImg + ')'
            _this.date.formatted = String(_this.parentSelected.DOB).substring(0, 10);
            // student details
            _this.parentSelected.StudentDetails.split('~').forEach(function (el) {
                _this.relatedStudents.push({ ID: el.split(',')[0], FirstName: el.split(',')[1],
                    LastName: el.split(',')[2], relation: el.split(',')[3] });
            });
            if (_this.profileImg) {
                $('#spnimgProfile').css('background-image', "url(" + __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */].serviceURL + "/UploadFile/Parent/" + _this.profileImg + ")");
            }
        }, function (err) { return console.error(err); });
    };
    ParentComponent.prototype.HideMessage = function () {
        this.message = '';
        // return this.isErrorMessage = !this.isErrorMessage;
    };
    // Update Parent
    ParentComponent.prototype.updateParent = function (id, parent) {
        var _this = this;
        parent.ID = id;
        parent.LastUpdatedBy = this.commonProperties.currentUser.ID; //JSON.parse(localStorage.getItem('currentUser')).ID;
        parent.LastModifiedOn = new Date();
        parent.ProfileImg = this.profileImg;
        this.parentService.updateParent(id, parent).subscribe(function (data) {
            // refresh the list
            // this.getParent();
            _this.message = 'Parent updated successfully! ';
            // this.router.navigate([this.returnUrl]);
            return true;
        }, function (error) {
    ...
    ParentComponent.prototype.onBack = function () {
        this.router.navigate([this.returnUrl]);
    };
    ParentComponent.prototype.saveParent = function (parent) {
        var _this = this;
        parent.CreatedBy = this.commonProperties.currentUser.ID; // JSON.parse(localStorage.getItem('currentUser')).ID;
        parent.CreatedOn = new Date();
        parent.ProfileImg = this.profileImg;
        //  console.log(Parent.ProfileImg);
        this.parentService.saveParent(parent).takeWhile(function () { return _this.isSubscribe; })
            .subscribe(function (resData) {
            // this.getParent();
    ...
    // Save Parent Record
    ParentComponent.prototype.submitParent = function (value) {
        if (!value.form.valid) {
        ...
        value.value.DOB = value.value.DOB.formatted;
        // format student details to save
        var studentDetails = '';
        // value.value.StudentDetails= 
        this.relatedStudents.forEach(function (el) {
            studentDetails = studentDetails + "~" + el.ID + "," + el.FirstName + "," + el.LastName + "," + el.relation;
        });
        if (studentDetails.length > 0) {
            studentDetails = studentDetails.substring(1);
        }
        //  console.log(studentDetails) ;
        value.value.StudentDetails = studentDetails;
        // end
        ...
        if (this.id > 0) {
            ...
            this.updateParent(this.id, value.value);
            value.form.reset();
            this.relatedStudents = [];
            $('#spnimgProfile').css('background-image', '');
        }
        else {
            // save image to folder
            if (this.fileList !== undefined && this.fileList.length > 0) {
    ...
    // file upload event  
    ParentComponent.prototype.fileChange = function (event) {
    ...
    ParentComponent.prototype.uploadProfile = function () {
        this.parentService.uploadProfile(this.fileList, this.profileImg);
        this.isUploaded = this.profileImg;
    };
    ParentComponent.prototype.onDateChange = function (dob) {
        if (isNaN(Date.parse(this.date.formatted))) {
            this.date.formatted = this.commonService.formateDate(this.objCurrentDate, 'yyyy-MM-dd');
        }
    };
    ParentComponent.prototype.getStudentRelation = function (student) {
        // this.searchValue='';
        var value = window.prompt('Please enter relationship');
        if (value == '') {
            this.getStudentRelation(student);
        }
        else {
            this.relatedStudents.push({ ID: student.ID, FirstName: student.FirstName,
                LastName: student.LastName, relation: value });
        }
        // console.log(value);
    };
    ParentComponent.prototype.filterStudentByNameEmail = function (value) {
        var _this = this;
        this.filteredItems = [];
        ...
        if (value != '' && value.length > 2) {
            this.studentList.forEach(function (element) {
                if ((JSON.stringify(element.FirstName).toLowerCase().indexOf(value.toLowerCase()) >= 0) ||
                    (JSON.stringify(element.Email).toLowerCase().indexOf(value.toLowerCase()) >= 0)) {
                    // if (JSON.stringify(element.FirstName).toLowerCase().indexOf(value.toLowerCase()) >= 0 ) {
                    _this.filteredItems.push(element);
                }
            });
        ...
        // else {
        //    this.filteredItems = this.studentList;
        // }
    };
    ParentComponent.prototype.removeStudentRelation = function (id) {
        this.relatedStudents = this.relatedStudents.filter(function (e) { return e.ID != id; });
    };
    // Get User
    ParentComponent.prototype.getStudent = function () {
        var _this = this;
        this.searchValue = '';
        this.filteredItems = [];
        this.studentService.getStudents()
            .subscribe(function (resData) { return _this.studentList = resData; }, function (err) { return console.error(err); });
    };
...
ParentComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* ActivatedRoute */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["c" /* Router */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__parent_service__["a" /* ParentService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__parent_service__["a" /* ParentService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__services_common_service__["a" /* CommonService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__services_common_service__["a" /* CommonService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_8__angular_http__["b" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__angular_http__["b" /* Http */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_9__angular_platform_browser__["c" /* DomSanitizer */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_9__angular_platform_browser__["c" /* DomSanitizer */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_7__student_student_service__["a" /* StudentService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__student_student_service__["a" /* StudentService */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__common_properties__["a" /* CommonProperties */]) === "function" && _h || Object])
], ParentComponent);
...
var StudentService = (function () {
    // preferred to use template literal rather concatination  like below line
    // CommonProperties.serviceURL + 'api/admins/';  // URL to web api 
    function StudentService(http, commonService) {
        this.http = http;
        this.commonService = commonService;
        this.studentServiceUrl = __WEBPACK_IMPORTED_MODULE_2__common_properties__["a" /* CommonProperties */].serviceURL + "api/students/";
    }
    ...
    StudentService.prototype.getStudentByID = function (id) {
        return this.http.get("" + this.studentServiceUrl + id)
            .map(function (res) { return res.json(); });
    };
    StudentService.prototype.saveStudent = function (student) {
        var body = JSON.stringify(student);
        return this.http.post(this.studentServiceUrl, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])())
            .map(function (res) { return res.json(); });
    };
    StudentService.prototype.deleteStudent = function (id) {
        return this.http.delete("" + this.studentServiceUrl + id);
    };
    StudentService.prototype.updateStudent = function (id, student) {
        var body = JSON.stringify(student);
        return this.http.put("" + this.studentServiceUrl + id, body, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__xhr_headers__["a" /* xhrHeaders */])()).map(function (res) { return res.json(); });
    };
    StudentService.prototype.uploadProfile = function (fileList, fileName) {
        if (fileList.length > 0) {
            var file = fileList[0];
            var formData = new FormData();
            formData.append('uploadFile', file, fileName);
            // this.commonService.uploadFile(formData);
            this.commonService.uploadFile(formData, 'Student');
        }
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__parent_component__ = __webpack_require__(753);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__parent_manage_component__ = __webpack_require__(752);
...
var routes = [
    {
        path: '',
        children: [
            { path: 'parent', component: __WEBPACK_IMPORTED_MODULE_1__parent_component__["a" /* ParentComponent */] },
            { path: 'parent/:id', component: __WEBPACK_IMPORTED_MODULE_1__parent_component__["a" /* ParentComponent */] },
            { path: 'manageparent', component: __WEBPACK_IMPORTED_MODULE_2__parent_manage_component__["a" /* ParentManageComponent */] },
        ],
    },
];
var routing = __WEBPACK_IMPORTED_MODULE_0__angular_router__["a" /* RouterModule */].forChild(routes);
//# sourceMappingURL=parent.routing.js.map
...
module.exports = "\n<div class=\"widgets\">\n        <div class=\"row\">\n            <div class=\"col-md-12\">\n                <div>\n                    <div baCardBlur class=\"animated fadeIn card {{cardType}} {{baCardClass || 'with-scroll'}}\" zoom-in>\n                    <!-- <ba-card title=\"Parent Form\" baCardClass=\"with-scroll\"> -->\n                            <div class=\"card-header clearfix\" >\n                                 <div class=\"form-group row\">\n                                    <div class=\"col-md-5\" ><h3 class=\"card-title\" translate>Parent Form</h3></div>\n                                     <!-- <label class=\"col-sm-2 form-control-label\">Rows on page</label> -->\n                                    <div class=\"col-md-7\" style=\"float:right;\"> \n                                       <button type=\"button\"  (click)=\"onBack()\" class=\"btn btn-primary btnBack\"><i class=\"fa fa-arrow-left\"></i> Back </button>\n                                    </div>\n                                    <div style=\"clear:both;\"></div>\n                                </div>\n                            </div>\n                            <div class=\"card-body\">\n                        <form #parentForm=\"ngForm\" class=\"form-horizontal\" (ngSubmit)=\"submitParent(parentForm)\">\n                            <!-- <div class=\"form-group row alert alert-success alert-dismissable\" >\n                                <label class=\"col-md-2\"> </label>\n                                <p class=\"form-group has-feedback col-md-10\" [ngClass]=\"isErrorMessage === true ? 'has-danger' : 'has-success'\">\n                                    <label class=\"form-control\" [ngClass]=\"isErrorMessage === true ? 'form-control-danger' : 'form-control-success'\" [style.color]=\"isErrorMessage === true ? 'red' : 'green' \" [ngStyle]=\"{'cursor':'pointer'}\" (click)=\"HideMessage()\"> {{message}} </label>\n                                </p>\n                            </div> -->\n                            <div class=\"alert alert-{{isErrorMessage?'danger':'success'}}\" *ngIf='message'>\n                                {{message}}\n                                <a class=\"close\" (click)=\"HideMessage()\">×</a>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">First Name</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!firstName.valid && firstName.touched), 'has-success':(firstName.valid && firstName.touched)}\">\n                                    <input id=\"firstName\" name=\"firstName\" #firstName='ngModel' type=\"text\" class=\"form-control\" required minlength=\"4\" placeholder=\"First Name\" [(ngModel)]=\"parentSelected.FirstName\">\n                                    <div *ngIf=\"firstName.invalid && (firstName.dirty || firstName.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"firstName.errors.required\">\n                                            Name is required\n                                        </div>\n                                        <div *ngIf=\"firstName.errors.minlength\">\n                                            Minimum 4 character.\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Last Name</label>\n                                <div class=\"col-sm-10\">\n                                    <input name=\"lastName\" type=\"text\" class=\"form-control\" placeholder=\"Last Name\" [(ngModel)]=\"parentSelected.LastName\">\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Email</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!email.valid && email.touched), 'has-success':(email.valid && email.touched)}\">\n                                    <input type=\"email\" #email='ngModel' name=\"email\" pattern=\"^\\w+([\\.-]?\\w+)*@\\w+([\\.-]?\\w+)*(\\.\\w{2,3})+$\" class=\"form-control\" required placeholder=\"Email\" [(ngModel)]=\"parentSelected.Email\">\n                                    <div *ngIf=\"email.invalid && (email.dirty || email.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"email.errors.required\">\n                                            Email is required\n                                        </div>\n                                        <div *ngIf=\"email.errors.pattern\">\n                                            Invalid Email\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Mobile</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!mobile.valid && mobile.touched), 'has-success':(mobile.valid && mobile.touched)}\">\n                                    <input type=\"text\" #mobile='ngModel' pattern=\"[789][0-9]{9}\" name=\"mobile\" class=\"form-control\" required placeholder=\"Mobile\" [(ngModel)]=\"parentSelected.Mobile\">\n                                    <div *ngIf=\"mobile.invalid && (mobile.dirty || mobile.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"mobile.errors.required\">\n                                            Mobile is required\n                                        </div>\n                                        <div *ngIf=\"mobile.errors.pattern\">\n                                            Invalid Mobile\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Password</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!password.valid && password.touched), 'has-success':(password.valid && password.touched)}\">\n                                    <input type=\"password\" #password='ngModel' class=\"form-control\" name=\"password\" required placeholder=\"Password\" [(ngModel)]=\"parentSelected.Password\">\n                                    <div *ngIf=\"password.invalid && (password.dirty || password.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"password.errors.required\">\n                                            Password is required\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">DOB  </label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!DOB.valid && DOB.touched), 'has-success':(DOB.valid && DOB.touched)}\">\n                                    <ng2-datepicker class=\"form-control2\" #DOB='ngModel' name=\"DOB\" required=\"required\" [options]=\"options\" [(ngModel)]=\"date\" (change)=\"onDateChange(DOB)\" ></ng2-datepicker>\n                                    <div *ngIf=\"DOB.invalid && (DOB.dirty || DOB.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"DOB.errors.required\">\n                                             Date is required\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Gender</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!Gender.valid && Gender.touched), 'has-success':(Gender.valid && Gender.touched)}\">\n                                    <select id=\"Gender\" #Gender='ngModel' name=\"Gender\" class=\"form-control\" initialValue=\"-1\" required size=\"1\" [(ngModel)]='parentSelected.Gender'>\n                                        <option [ngValue]=\"i.id\" *ngFor=\"let i of genders\" [selected]=\"i.id == parentSelected.Gender\">{{i.name}}</option>\n                                    </select>\n                                    <div *ngIf=\"Gender.invalid && (Gender.dirty || Gender.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"Gender.errors.required\">\n                                            Please select gender\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Address</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!address.valid && address.touched), 'has-success':(address.valid && address.touched)}\">\n                                    <input name=\"address\" #address='ngModel' type=\"text\" class=\"form-control\" required placeholder=\"Address\" [(ngModel)]=\"parentSelected.Address\">\n                                    <div *ngIf=\"address.invalid && (address.dirty || address.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"address.errors.required\">\n                                            Address is required\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">City</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!City.valid && City.touched), 'has-success':(City.valid && City.touched)}\">\n                                    <input name=\"City\" #City='ngModel' type=\"text\" class=\"form-control\" required placeholder=\"City\" [(ngModel)]=\"parentSelected.City\">\n                                    <div *ngIf=\"City.invalid && (City.dirty || City.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"City.errors.required\">\n                                                City is required\n                                        </div>\n    \n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">State</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!State.valid && State.touched), 'has-success':(State.valid && State.touched)}\">\n                                    <input name=\"State\" #State='ngModel' type=\"text\" class=\"form-control\" required placeholder=\"State\" [(ngModel)]=\"parentSelected.State\">\n                                    <div *ngIf=\"State.invalid && (State.dirty || State.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"State.errors.required\">\n                                                State is required\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">PinCode</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!Pincode.valid && Pincode.touched && (!Pincode.errors.minlength)), 'has-success':(Pincode.valid && Pincode.touched)}\">\n                                    <input name=\"Pincode\" #Pincode='ngModel' pattern=\"^[1-9][0-9]{5}$\" type=\"text\" class=\"form-control\" maxlength=\"6\" minlength=\"6\" placeholder=\"Pincode\" [(ngModel)]=\"parentSelected.Pincode\">\n                                    <div *ngIf=\"Pincode.invalid && (Pincode.dirty || Pincode.touched)\" class=\"validationError\">\n                                            <div *ngIf=\"Pincode.errors.pattern && (!Pincode.errors.minlength)\">\n                                                    Invalid Pincode.\n                                            </div>\n                                        <div *ngIf=\"Pincode.errors.minlength\">\n                                                    Minimum 6 character.\n                                         </div>\n                                        </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\" [hidden]='true'>\n                                <label class=\"col-sm-2 form-control-label\">Upload</label>\n    \n                                <div class=\"col-sm-9\" [ngClass]=\"{'has-error':(!imgProfile.valid && imgProfile.touched), 'has-success':(imgProfile.valid && imgProfile.touched)}\">\n                                    <input type=\"file\" id=\"btnUpload\" class=\"form-control\" name=\"imgProfile\" #imgProfile value=\"Upload\" (change)=\"commonService.readURL(imgProfile); fileChange(imgProfile);\" />\n                                </div>\n                                <div class=\"col-sm-1\">\n                                    <img width=\"45\" style=\"float:right; border-radius:47%;\" name='noImage' height=\"40\" id=\"imgProfile1\" src='{{noImage}}' alt=\"your image\" />\n                                </div>\n                                <!-- <div class=\"col-sm-1\" >\n                                <span class=\"form-control-label\" *ngIf=\"isUploaded\">Uploaded </span>\n                                </div> -->\n                                <!-- <div class=\"col-sm-1\" style=\"text-align:left;\" >\n                                    <button type=\"button\" class=\"btn btn-success\" [disabled]='!isFileSelected'  (click)=\"uploadProfile()\" >Upload</button>\n                                </div> -->\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Profile Image</label>\n                                <div class=\"col-sm-10\">\n                                    <span class=\"select-wrapper\" id=\"spnimgProfile\">\n                                        <input type=\"file\" id=\"imgProfile\" name=\"imgProfile\" #imgProfile value=\"Upload\" (change)=\"commonService.readURL(imgProfile); fileChange(imgProfile);\" />\n                                    </span>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Profession</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!Profession.valid && Profession.touched), 'has-success':(Profession.valid && Profession.touched)}\">\n                                    <input name=\"Profession\" #Profession='ngModel' type=\"text\" class=\"form-control\" required placeholder=\"Profession\" [(ngModel)]=\"parentSelected.Profession\">\n                                    <div *ngIf=\"Profession.invalid && (Profession.dirty || Profession.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"Profession.errors.required\">\n                                            Profession is required\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n                            <div class=\"form-group row\" [hidden]='true'>\n                                <label class=\"col-sm-2 form-control-label\">Student Details</label>\n                                <div class=\"col-sm-10\">\n                                    <i class=\"btn btn-danger ion-person-stalker\" style=\"cursor:pointer\" data-toggle=\"modal\" data-target=\"#myModalStudent\" (click)=\"getStudent();\" > Link Student</i>\n                                    <div  style=\"margin-left:0px; padding-top:5px; padding-right: 10px;\" class=\"row ng-scope\" *ngFor=\"let student of relatedStudents; let i=index \">\n                                            <div  style=\"padding-right: 10px;\" class=\"col-xs-4\"><input type=\"text\" class=\"form-control ng-pristine ng-valid\" disabled=\"disabled\" value=\"{{student.FirstName}} {{student.LastName}}\" ></div>\n                                            <div  style=\"padding-right: 10px;\" class=\"col-xs-4\"><input type=\"text\" name='relation{{i}}' class=\"form-control ng-pristine ng-valid\"  placeholder=\"Relation\" [(ngModel)]='student.relation' ></div>\n                                            <!-- <a type=\"button\" ng-click=\"removeStudent(studentOne.id)\" class=\"btn btn-danger btn-flat\"><i class=\"fa fa-trash-o\"></i></a> -->\n                                            <i class=\"btn btn-danger ion-trash-a\" style=\"cursor:pointer\" data-toggle=\"modal\" data-target=\"#myModalDelete\" (click)=\"removeStudentRelation(student.ID)\" ></i>\n                                    </div>\n                                </div>\n                                \n                            </div>\n                            \n                            <div class=\"form-group row\">\n                                <label class=\"col-sm-2 form-control-label\">Active</label>\n                                <div class=\"col-sm-10\" [ngClass]=\"{'has-error':(!IsActive.valid && IsActive.touched), 'has-success':(IsActive.valid && IsActive.touched)}\">\n                                    <select id=\"IsActive\" #IsActive='ngModel' name=\"IsActive\" class=\"form-control\" required size=\"1\" [(ngModel)]='parentSelected.IsActive'>\n                                        <option [ngValue]=\"i.id\" *ngFor=\"let i of actives; let idx = index\" [selected]=\"i.id == parentSelected.IsActive\">{{i.name}}</option>\n                                    </select>\n                                    <div *ngIf=\"IsActive.invalid && (IsActive.dirty || IsActive.touched)\" class=\"validationError\">\n                                        <div *ngIf=\"IsActive.errors.required\">\n                                            Please select status\n                                        </div>\n                                    </div>\n                                </div>\n                            </div>\n    \n                            <div class=\"form-group row\">\n                                <div class=\"offset-sm-2 col-sm-10\">\n                                   \n                                    <button type=\"submit\" class=\"btn btn-danger\" [disabled]='!parentForm.form.valid'>Submit</button>\n                                    <!-- <button type=\"reset\" class=\"btn btn-sm btn-danger\"><i class=\"fa fa-ban\"></i> Reset </button> -->\n                                </div>\n                            </div>\n                        </form>\n                    </div>\n                    <!-- </ba-card> -->\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n\n    <!-- Modal  style=\"background-color: #69AFD2; 868686\" -->\n<div id=\"myModalStudent\" class=\"modal fade\" role=\"dialog\" >\n    <div class=\"modal-dialog\">\n      <!-- Modal content-->\n      <div class=\"modal-content\" style=\"background-color: #65a4c1; color:#fff;\">\n        <div class=\"modal-header\" style=\" padding: 10px 15px; border-bottom: 1px solid #ddd;\">\n          <h4 class=\"modal-title\" >Link student to parent</h4>\n          <button type=\"button\" class=\"close\" data-dismiss=\"modal\">&times;</button>\n        </div>\n        <div class=\"modal-body\"  >\n              <div>\n                <div class=\"input-group\">\n                    <input type=\"text\" #search='ngModel' [(ngModel)]='searchValue'  placeholder=\"Type student name / E-mail address\"  class=\"form-control with-danger-addon\" (keyup)=\"filterStudentByNameEmail(search.value);\" >\n                    <span class=\"input-group-btn\">\n                        <button class=\"btn btn-danger\" type=\"button\" (click)=\"filterStudentByNameEmail(search.value);\" ><i class=\"fa fa-search\" style=\"font-size:16px;\" aria-hidden=\"true\"></i></button>\n                    </span>\n                </div>\n                <div class=\"horizontal-scroll\">\n                <table class=\"table table-bordered \"> \n                    <tbody>\n                        <tr *ngFor=\"let student of filteredItems\">\n                                <td style=\"display:none;\" >{{student.ID}}</td>\n                                <td>{{student.FirstName}}</td>\n                                <td>{{student.Email}}</td>\n                                <td><i class=\"btn btn-success\" style=\"cursor:pointer\" (click)='getStudentRelation(student);' >select</i></td>\n                        </tr>\n                        <tr *ngIf=\"this.filteredItems?.length===0\">\n                            <td colspan=\"4\">  <span  > No records found  </span>  </td>\n                        </tr>\n                    </tbody>\n                </table>\n            </div>\n          </div>\n        </div>\n        <div class=\"modal-footer\" style=\"text-align:center;\" >\n          <i type=\"button\" class=\"btn btn-primary\" data-dismiss=\"modal\">Cancel</i>\n        </div>\n      </div>\n  \n    </div>\n</div>\n    "
